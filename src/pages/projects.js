            ...
            <Layout classname='pt-16'>
                ...
                <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                    <div className='col-span-12'>
                       ...
                       img={project1}
                       link= 
                       'https://web-portfolio-hadi-ramadhan-1.hadiramadhan.repl.co/'
                    ...
                    <Project
                       ...
                       img={project2}
                       link= 
                       'https://my-wedding.hadiramadhan.repl.co/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 2"
                       />
                    </div>
                    ...
                    <Project
                       ...
                       img={project3}
                       link= 
                       'https://portofolio-hadi.hadiramadhan.repl.co/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 2"
                       />
                    </div>
                    <div className='col-span-12 p-2'>
                       ...
                       img={project4}
                       link= 
                       'https://cuanki-mie--cuankicuankimie.repl.co/'
                       github="https://github.com/HadiRamadhan"
                       type="Project 4"
                       />
                    </div>
